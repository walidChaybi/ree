...
export const resultatRequeteUtilistateurLaurenceBourdeau = {
  ...
  data: {
    ...
    service: {
      idService: "9587b5bd-659c-456a-a798-b60e913bb51b",
      type: "SERVICE",
      code: "SCEC",
    ...
    servicesFilsDirects: [
      {
        idService: "95874527-b387-45bb-acef-4cd697109481",
        type: "DEPARTEMENT",
        code: "BAJ",
      ...
      },
      {
        ...
        libelleService: "BTM Annaba et Constantine",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
      ...
      },
      {
        ...
        libelleService: "BTE Suisse et Lichtenstein",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
      ...
      },
      {
        ...
        type: "SECTION",
        code: "BO/CAD",
        libelleService: "Bureau d'Ordre / Centre d'Archive et Documentation",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
      ...
      },
      {
        ...
        libelleService: "Secrétariat de l'établissement",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
      ...
      },
      {
        ...
        type: "SECTION",
        code: "Formation EXP",
        libelleService: "Cellule Formation Exploitation",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
      ...
      },
      {
        ...
        type: "SECTION",
        code: "Formation ETA",
        libelleService: "Cellule Formation Etablissement",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
      ...
      },
      {
        ...
        libelleService: "Secrétariat de l'exploitation",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
      ...
      },
      {
        ...
        libelleService: "Secrétariat BAC",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
      ...
      },
      {
        ...
        libelleService: "Secrétariat du SCEC",
        siteInternet: null,
        hierarchieService: [
          {
            service: null,
...
export const resultatRequeteUtilistateurLeBiannic = {
  ...
  data: {
    ...
    habilitations: [
      ...
      {
        idHabilitation: "bf166510-17af-40e9-8b72-63eed03d80a8",
        typeDelegation: null,
        roleDelegant: null,
        villePosteConsulaire: null,
        dateDebut: 1685570400000,
        dateFin: null,
        profil: {
          idProfil: "3bedd70b-b39a-45e8-9f3a-8c55384252b8",
          nom: {
            idNomenclature: "a776da84-eb7e-40a9-b8a2-3df779a1e951",
            categorie: "TYPE_PROFIL",
            code: "DROIT_SIGNER_MENTION",
            libelle: "Signer mention",
            estActif: true
          },
          habilitation: null,
          profilDroit: [
            {
              droit: {
                idDroit: "5d337894-7133-429f-9dea-c72d9927be61",
                nom: "SIGNER_MENTION",
                profilDroit: null
              },
              profil: null
        ...
        perimetre: {
          ...
          listePays: null,
          listeIdTypeRegistre: [
            "415a6a21-ab4a-404e-8963-199214c0054d",
            "ff4e17c6-34c2-420f-856f-aad6161342e4",
            "7421357e-7ee1-4607-acfe-d4db23dccd6d"
          ]
        }
      }
    ],
