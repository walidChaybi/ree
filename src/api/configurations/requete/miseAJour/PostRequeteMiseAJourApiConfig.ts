...
interface IBody {
  ...
  sousType: typeof SousTypeMiseAJour.RMAC.nom | typeof SousTypeMiseAJour.RMAR.nom;
...
export const CONFIG_POST_REQUETE_MISE_A_JOUR: TConfigurationApi<typeof URI, IBody, undefined, IResultat> = {
  api: REQUETE_API,
  methode: "POST",
  uri: URI
};
