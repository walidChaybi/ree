...
test("Attendu: getTypeDocument fonctionne correctement", () => {
  expect(
    DocumentDelivrance.getTypeDocument(
  ...
  ).toBe("ff7fe1fa-a2d6-4bc5-8681-deba65d9e2c6");

  expect(
    DocumentDelivrance.getTypeDocument(
      ChoixDelivrance.DELIVRER_EC_COPIE_INTEGRALE
    )
  ).toBe("0e1e909f-f74c-4b16-9c03-b3733354c6ce");

  expect(
    DocumentDelivrance.getTypeDocument(
      ChoixDelivrance.DELIVRER_EC_COPIE_ARCHIVE
    )
  ).toBe("8b808725-a83e-4ce5-81a2-192cd09e0cb2");
});
