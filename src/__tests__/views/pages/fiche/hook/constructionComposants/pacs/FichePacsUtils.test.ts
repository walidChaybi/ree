...
test("ficheUtils Pacs fonctionne avec modification notaire", () => {
  ...
  expect(
    (panels.panels[0].panelAreas[0].parts as SectionPartProps[])[0].partContent
      ?.contents.length
  ).toBe(3);
  expect(
    (panels.panels[0].panelAreas[0].parts as SectionPartProps[])[0].partContent
  ...
  expect(
    (panels.panels[0].panelAreas[1].parts as SectionPartProps[])[0].partContent
      ?.title
  ).toBe("Partenaire 1");
  expect(
    (panels.panels[0].panelAreas[1].parts as SectionPartProps[])[0].partContent
  ...
  expect(
    (panels.panels[0].panelAreas[2].parts as SectionPartProps[])[0].partContent
      ?.contents.length
  ).toBe(4);
  expect(
    (panels.panels[0].panelAreas[2].parts as SectionPartProps[])[0].partContent
  ...
  expect(
    (panels.panels[0].panelAreas[3].parts as SectionPartProps[])[0].partContent
      ?.contents.length
  ).toBe(5);
  expect(
    (panels.panels[0].panelAreas[3].parts as SectionPartProps[])[0].partContent
  ...
  // 4.2: Localisation
  expect(
    (panels.panels[0].panelAreas[3].parts as SectionPartProps[])[1].partContent
      ?.contents.length
  ).toBe(4);
});
...
test("ficheUtils Pacs fonctionne avec annulation juridiction", () => {
  ...
  // 3.2 Localisation
  expect(
    (panels.panels[0].panelAreas[2].parts as SectionPartProps[])[1].partContent
      ?.contents[0].libelle
  ).toBe("Ville");
  expect(
    (panels.panels[0].panelAreas[2].parts as SectionPartProps[])[1].partContent
