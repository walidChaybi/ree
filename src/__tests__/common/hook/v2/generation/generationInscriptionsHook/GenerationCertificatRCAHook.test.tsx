...
const requete = {
  ...
  document: ReponseAppelNomenclatureDocummentDelivrance.data[7].id, //CERTIFICAT_SITUATION_PACS
  titulaires: [titulaire]
} as IRequeteTableau;

const dataRMCAutoInscription = DataRMCInscriptionAvecUnSeulResultat;
