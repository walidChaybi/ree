...
test("ficheUtils Pacs fonctionne avec modification notaire", async () => {
  ...
  expect(
    panels.panels[0].panelAreas[0].parts[0].partContent.contents.length
  ).toBe(3);
  expect(
    panels.panels[0].panelAreas[0].parts[0].partContent.contents[0].libelle
  ).toBe("Statut du PACS");
  expect(
  ...
  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents.length
  ).toBe(8);
  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[0].libelle
  ).toBe("Nom");
  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[0].value
  ).toBe("DUREL");

  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[1].libelle
  ).toBe("Autre(s) nom(s)");
  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[1].value
  ).toBe("DUDU, DUDU2");

  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[2].libelle
  ).toBe("Prénoms");
  expect(
  ...
  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[3].value
  ).toBe("Natacha, Natacha2");

  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[4].libelle
  ).toBe("Date de naissance");
  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[4].value
  ).toBe("01/09/1983");

  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[5].libelle
  ...
  expect(
    panels.panels[0].panelAreas[1].parts[0].partContent.contents[6].value
  ).toBe("Française");
  ...
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents.length
  ).toBe(4);
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents[0].libelle
  ).toBe("Autorité");
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents[0].value
  ).toBe("Notaire");
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents[1].libelle
  ).toBe("Prénom nom");
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents[1].value
  ).toBe("Maître Dominique ESTER");
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents[2].libelle
  ).toBe("N° CRPCEN");
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents[2].value
  ).toBe("1235467890");
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents[3].libelle
  ).toBe("Date");
  expect(
    panels.panels[0].panelAreas[2].parts[0].partContent.contents[3].value
  ).toBe("19/01/1970");
  ...
  expect(
    panels.panels[0].panelAreas[3].parts[0].partContent.contents.length
  ).toBe(5);
  expect(
    panels.panels[0].panelAreas[3].parts[0].partContent.contents[0].libelle
  ).toBe("Autorité");
  expect(
    panels.panels[0].panelAreas[3].parts[0].partContent.contents[0].value
  ).toBe("Notaire");
  expect(
    panels.panels[0].panelAreas[3].parts[0].partContent.contents[1].libelle
  ).toBe("Prénom nom");
  expect(
  ...
  expect(
    panels.panels[0].panelAreas[3].parts[0].partContent.contents[3].value
  ).toBe("22/01/2021");
  expect(
    panels.panels[0].panelAreas[3].parts[0].partContent.contents[4].libelle
...
test("ficheUtils Pacs fonctionne avec annulation juridiction", async () => {
  ...
  // 3.2 Localisation
  expect(
    panels.panels[0].panelAreas[2].parts[1].partContent.contents[0].libelle
  ).toBe("Ville");
  expect(
  ...
  expect(
    panels.panels[0].panelAreas[2].parts[1].partContent.contents[2].value
  ).toBe("");
