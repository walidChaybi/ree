...
test("Habilitation model", () => {
  ...
  let estAutorise = estOfficierHabiliterPourTousLesDroits(utilisateurConnecte, [
...
test("Utilisateur autoriser à consulter l'acte dont l'idTypeRegistre est passé", () => {
  ...
  let autoriserAConsulterActe = officierDroitConsulterSurLeTypeRegistre(
    utilisateurConnecte,
    idTypeRegistre
  );
  ...
  autoriserAConsulterActe = officierDroitConsulterSurLeTypeRegistre(
    utilisateurConnecte,
    idTypeRegistre
  );
...
test("Attendu: estOfficierHabiliterPourUnDesDroits fonctionne correctement", () => {
  let utilisateurConnecte = mappingOfficier(
    resultatHeaderUtilistateurLaurenceBourdeau,
  ...
  expect(
    estOfficierHabiliterPourUnDesDroits(utilisateurConnecte, [])
  ).toBeTruthy();
