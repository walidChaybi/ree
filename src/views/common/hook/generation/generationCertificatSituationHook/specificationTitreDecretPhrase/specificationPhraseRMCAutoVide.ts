...
class Specification {
  ...
  getPhrase(sexe: Sexe, nbInscriptionsInfos: INbInscriptionsInfos) {
    ...
    if (this.condition.estVerifiee(nbInscriptionsInfos)) {
      phrasesLiees = sexe === Sexe.FEMININ ? this.phraseFeminin : this.phraseMasculin;
    }
...
class SpecificationPhrase {
  ...
  getPhrasesJasper(idDocumentDemande: string, sexe: Sexe, nbInscriptionsInfos: INbInscriptionsInfos): IPhrasesJasperCertificatSituation {
