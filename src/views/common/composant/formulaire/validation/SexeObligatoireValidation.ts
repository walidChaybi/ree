...
export const sexeObligatoireValidation = function (context: any, value: IParentNaissanceForm, error: any) {
  let res: any = true;
  if (value && value.nomNaissance && (!value.sexe || Sexe.getEnumFor(value.sexe) === Sexe.INCONNU)) {
    const paramsError = {
