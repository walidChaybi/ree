...
export const URL_MES_REQUETES_DELIVRANCE_APERCU_PRISE_EN_CHARGE_COURRIER_ID = `${URL_MES_REQUETES_DELIVRANCE}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/${ID}`;
export const URL_MES_REQUETES_DELIVRANCE_APERCU_TRAITEMENT_COURRIER_ID = `${URL_MES_REQUETES_DELIVRANCE}/${PATH_APERCU_REQ_TRAITEMENT}/${PATH_APERCU_COURRIER}/${ID}`;
export const URL_MES_REQUETES_DELIVRANCE_EXTRAIT_COPIE_COURRIER_ID = `${URL_MES_REQUETES_DELIVRANCE_SAISIR_RDC}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/${ID}`;
...
// Modification courrier depuis apercu
export const URL_REQUETES_DELIVRANCE_SERVICE_APERCU_PRISE_EN_CHARGE_COURRIER_ID = `${URL_REQUETES_DELIVRANCE_SERVICE}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/${ID}`;
export const URL_REQUETES_DELIVRANCE_SERVICE_APERCU_TRAITEMENT_COURRIER_ID = `${URL_REQUETES_DELIVRANCE_SERVICE}/${PATH_APERCU_REQ_TRAITEMENT}/${PATH_APERCU_COURRIER}/${ID}`;
export const URL_REQUETES_DELIVRANCE_SERVICE_EXTRAIT_COPIE_COURRIER_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDC}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/${ID}`;
...
// Modification courrier depuis apercu
export const URL_RECHERCHE_REQUETE_APERCU_PRISE_EN_CHARGE_COURRIER_ID = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/${ID}`;
export const URL_RECHERCHE_REQUETE_APERCU_TRAITEMENT_COURRIER_ID = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_TRAITEMENT}/${PATH_APERCU_COURRIER}/${ID}`;
