...
const PATH_APERCU_REQUETE_CREATION_ETABLISSEMENT_ACTE_REGISTRE = "apercurequetecreationetablissementacteregistre";
export const PATH_APERCU_REQ_TRANSCRIPTION_SIMPLE = "apercurequetetranscriptionsimple";
export const PATH_APERCU_REQ_TRANSCRIPTION_EN_PRISE_CHARGE = "apercu-requete-transcription-en-prise-en-charge";
export const PATH_APERCU_REQ_TRANSCRIPTION_EN_SAISIE_PROJET = "requete-transcription-saisie-projet";
export const PATH_EDITION = "Edition";
export const PATH_SAISIR_RDCSC = "saisircertificatsituation";
const PATH_SAISIR_RDC = "saisirextraitcopie";
const PATH_SAISIR_RCTC = "saisir-requete-transcription";
const PATH_SAISIR_RDLFC = "saisirlivretfamille";
export const PATH_MODIFIER_RDC = "modifierextraitcopie";
export const PATH_MODIFIER_RDCSC = "modifiercertificatsituation";
const PATH_APERCU_REQ_MISE_A_JOUR_SUITE_AVIS = "requetemiseajoursuiteavis";
const PATH_APERCU_REQ_MISE_A_JOUR_AUTRE = "requetemiseajourautre";
const PATH_APERCU_REQ_MISE_A_JOUR_ANALYSE_MARGINALE = "requete-mise-a-jour-analyse-marginale";
...
////////////////////////////////////////////////////////
const URL_REQUETE_MISE_A_JOUR_MENTIONS_SUITE_AVIS = `${URL_BASE}/${PATH_APERCU_REQ_MISE_A_JOUR_SUITE_AVIS}`;
const URL_REQUETE_MISE_A_JOUR_MENTIONS_AUTRE = `${URL_BASE}/${PATH_APERCU_REQ_MISE_A_JOUR_AUTRE}`;
const URL_REQUETE_MISE_A_JOUR_ANALYSE_MARGINALE = `${URL_BASE}/${PATH_APERCU_REQ_MISE_A_JOUR_ANALYSE_MARGINALE}`;
