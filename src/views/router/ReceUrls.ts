...
export const PATH_APERCU_REQ_CREATION_ETABLISSEMENT =
  "apercurequetecreationetablissement";
...
export const URL_RECHERCHE_REQUETE_APERCU_REQUETE_CREATION_ID = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_CREATION_ETABLISSEMENT}/${ID}`;
...
export const URL_MES_REQUETES_CREATION_ETABLISSEMENT_APERCU_REQUETE_ID = `${URL_MES_REQUETES_CREATION}/${PATH_APERCU_REQ_CREATION_ETABLISSEMENT}/${ID}`;
...
export const URL_REQUETES_CREATION_SERVICE_APERCU_REQUETE_ID = `${URL_REQUETES_CREATION_SERVICE}/${PATH_APERCU_REQ_CREATION_ETABLISSEMENT}/${ID}`;
