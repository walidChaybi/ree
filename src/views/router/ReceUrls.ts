...
export const URL_MES_REQUETES_DETAIL_REQUETE_TRAITEMENT_COURRIER = `${URL_MES_REQUETES_V2}/${PATH_APERCU_REQ_TRAITEMENT}/${PATH_APERCU_COURRIER}/${PATH_DETAIL_REQ}/:idRequete`;
export const URL_MES_REQUETES_DETAIL_REQUETE_PRISE_COURRIER = `${URL_MES_REQUETES_V2}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/${PATH_DETAIL_REQ}/:idRequete`;
...
export const URL_REQUETES_SERVICE_DETAIL_REQUETE_PRISE_COURRIER = `${URL_REQUETES_SERVICE_V2}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/${PATH_DETAIL_REQ}/:idRequete`;
export const URL_REQUETES_SERVICE_DETAIL_REQUETE_TRAITEMENT_COURRIER =
  `${URL_REQUETES_SERVICE_V2}/${PATH_APERCU_REQ_TRAITEMENT}/${PATH_APERCU_COURRIER}` +
  `/${PATH_DETAIL_REQ}/:idRequete`;
...
export const URL_RECHERCHE_REQUETE_DETAIL_REQUETE_PRISE_COURRIER = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/${PATH_DETAIL_REQ}/:idRequete`;
export const URL_RECHERCHE_REQUETE_DETAIL_TRAITEMENT_COURRIER = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_TRAITEMENT}/${PATH_APERCU_COURRIER}/${PATH_DETAIL_REQ}/:idRequete`;
