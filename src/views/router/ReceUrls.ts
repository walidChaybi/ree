...
export const URL_MES_REQUETES_DELIVRANCE_APERCU_REQUETE_ID = `${URL_MES_REQUETES_DELIVRANCE}/${PATH_APERCU_REQ_DEL}/:idRequete`;
export const URL_MES_REQUETES_DELIVRANCE_APERCU_REQUETE_PRISE_EN_CHARGE_ID = `${URL_MES_REQUETES_DELIVRANCE}/${PATH_APERCU_REQ_PRISE}/:idRequete`;
export const URL_MES_REQUETES_DELIVRANCE_APERCU_REQUETE_TRAITEMENT_ID = `${URL_MES_REQUETES_DELIVRANCE}/${PATH_APERCU_REQ_TRAITEMENT}/:idRequete`;
...
export const URL_MES_REQUETES_DELIVRANCE_SAISIR_RDCSC_APERCU_REQUETE_ID = `${URL_MES_REQUETES_DELIVRANCE_SAISIR_RDCSC}/${PATH_APERCU_REQ_DEL}/:idRequete`;
export const URL_MES_REQUETES_DELIVRANCE_SAISIR_RDCSC_APERCU_REQUETE_PRISE_EN_CHARGE_ID = `${URL_MES_REQUETES_DELIVRANCE_SAISIR_RDCSC}/${PATH_APERCU_REQ_PRISE}/:idRequete`;
export const URL_MES_REQUETES_DELIVRANCE_SAISIR_RDCSC_APERCU_REQUETE_TRAITEMENT_ID = `${URL_MES_REQUETES_DELIVRANCE_SAISIR_RDCSC}/${PATH_APERCU_REQ_TRAITEMENT}/:idRequete`;

// Aperçu requête ... après saisie de requête RDC depuis Mes Requêtes de DELIVRANCE
export const URL_MES_REQUETES_DELIVRANCE_SAISIR_RDC_APERCU_REQUETE_ID = `${URL_MES_REQUETES_DELIVRANCE_SAISIR_RDC}/${PATH_APERCU_REQ_DEL}/:idRequete`;
export const URL_MES_REQUETES_DELIVRANCE_SAISIR_RDC_APERCU_REQUETE_PRISE_EN_CHARGE_ID = `${URL_MES_REQUETES_DELIVRANCE_SAISIR_RDC}/${PATH_APERCU_REQ_PRISE}/:idRequete`;
export const URL_MES_REQUETES_DELIVRANCE_SAISIR_RDC_APERCU_REQUETE_TRAITEMENT_ID = `${URL_MES_REQUETES_DELIVRANCE_SAISIR_RDC}/${PATH_APERCU_REQ_TRAITEMENT}/:idRequete`;
...
export const URL_MES_REQUETES_DELIVRANCE_APERCU_PRISE_EN_CHARGE_COURRIER_ID = `${URL_MES_REQUETES_DELIVRANCE}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/:idRequete`;
export const URL_MES_REQUETES_DELIVRANCE_APERCU_TRAITEMENT_COURRIER_ID = `${URL_MES_REQUETES_DELIVRANCE}/${PATH_APERCU_REQ_TRAITEMENT}/${PATH_APERCU_COURRIER}/:idRequete`;
export const URL_MES_REQUETES_DELIVRANCE_EXTRAIT_COPIE_COURRIER_ID = `${URL_MES_REQUETES_DELIVRANCE_SAISIR_RDC}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/:idRequete`;
...
export const URL_REQUETES_DELIVRANCE_SERVICE_APERCU_REQUETE_ID = `${URL_REQUETES_DELIVRANCE_SERVICE}/${PATH_APERCU_REQ_DEL}/:idRequete`;
export const URL_REQUETES_DELIVRANCE_SERVICE_APERCU_REQUETE_PRISE_EN_CHARGE_ID = `${URL_REQUETES_DELIVRANCE_SERVICE}/${PATH_APERCU_REQ_PRISE}/:idRequete`;
export const URL_REQUETES_DELIVRANCE_SERVICE_APERCU_REQUETE_TRAITEMENT_ID = `${URL_REQUETES_DELIVRANCE_SERVICE}/${PATH_APERCU_REQ_TRAITEMENT}/:idRequete`;
...
export const URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDCSC_APERCU_REQUETE_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDCSC}/${PATH_APERCU_REQ_DEL}/:idRequete`;
export const URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDCSC_APERCU_REQUETE_PRISE_EN_CHARGE_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDCSC}/${PATH_APERCU_REQ_PRISE}/:idRequete`;
export const URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDCSC_APERCU_REQUETE_TRAITEMENT_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDCSC}/${PATH_APERCU_REQ_TRAITEMENT}/:idRequete`;

// Aperçu requête ... après saisie de requête RDC depuis Mes Requêtes de SERVICE
export const URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDC_APERCU_REQUETE_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDC}/${PATH_APERCU_REQ_DEL}/:idRequete`;
export const URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDC_APERCU_REQUETE_PRISE_EN_CHARGE_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDC}/${PATH_APERCU_REQ_PRISE}/:idRequete`;
export const URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDC_APERCU_REQUETE_TRAITEMENT_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDC}/${PATH_APERCU_REQ_TRAITEMENT}/:idRequete`;

// Modification Brouillon dans Saisie RDCSC depuis Mes Requêtes service de DELIVRANCE
export const URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDCSC_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDCSC}/:idRequete`;

// Modification courrier depuis apercu
export const URL_REQUETES_DELIVRANCE_SERVICE_APERCU_PRISE_EN_CHARGE_COURRIER_ID = `${URL_REQUETES_DELIVRANCE_SERVICE}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/:idRequete`;
export const URL_REQUETES_DELIVRANCE_SERVICE_APERCU_TRAITEMENT_COURRIER_ID = `${URL_REQUETES_DELIVRANCE_SERVICE}/${PATH_APERCU_REQ_TRAITEMENT}/${PATH_APERCU_COURRIER}/:idRequete`;
export const URL_REQUETES_DELIVRANCE_SERVICE_EXTRAIT_COPIE_COURRIER_ID = `${URL_REQUETES_DELIVRANCE_SERVICE_SAISIR_RDC}/${PATH_APERCU_REQ_PRISE}/${PATH_APERCU_COURRIER}/:idRequete`;
...
export const URL_RECHERCHE_REQUETE_APERCU_REQUETE_ID = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_DEL}/:idRequete`;
...
export const URL_MES_REQUETES_APERCU_REQ_INFORMATION_ID = `${URL_MES_REQUETES_INFORMATION}/${PATH_APERCU_REQ_INFO}/:idRequete`;

// Aperçu d'une requête d'information depuis RMC Requêtes
export const URL_RECHERCHE_REQUETE_APERCU_REQUETE_INFORMATION_ID = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_INFO}/:idRequete`;
...
// Aperçu d'une requête d'information
export const URL_REQUETES_INFORMATION_SERVICE_APERCU_REQUETE_ID = `${URL_REQUETES_INFORMATION_SERVICE}/${PATH_APERCU_REQ_INFO}/:idRequete`;
