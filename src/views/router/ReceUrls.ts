...
function getUrlLongue(urlName: string) {
  switch (urlName) {
    case "URL_RECHERCHE_REQUETE_APERCU_REQUETE_CREATION_ETABLISSEMENT_SAISIE_PROJET_ID":
      return `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_ETABLISSEMENT_SAISIE_PROJET}/${ID}/${ID_ETAT_CIVIL}`;
    case "URL_REQUETES_CREATION_SERVICE_ETABLISSEMENT_APERCU_SAISIE_PROJET_ID":
      return `${URL_REQUETES_CREATION_SERVICE}/${PATH_APERCU_REQ_ETABLISSEMENT_SAISIE_PROJET}/${ID}/${ID_ETAT_CIVIL}`;
