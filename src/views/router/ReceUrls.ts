...
function getUrlLongue(urlName: string) {
  switch (urlName) {
    ...
    case "URL_REQUETES_CREATION_SERVICE_TRANSCRIPTION_APERCU_REQUETE_SAISIE_PROJET_ID":
      return `${URL_REQUETES_CREATION_SERVICE}/${PATH_APERCU_REQ_TRANSCRIPTION_EN_SAISIE_PROJET}/${ID}`;
    ...
    case "URL_REQUETES_CREATION_SERVICE_ETABLISSEMENT_APERCU_ACTE_REGISTRE_ID":
      return `${URL_REQUETES_CREATION_SERVICE}/${PATH_APERCU_REQUETE_CREATION_ETABLISSEMENT_ACTE_REGISTRE}/${ID}/${ID_ACTE}`;
    default:
