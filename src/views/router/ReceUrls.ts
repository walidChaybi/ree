...
const ID_ETAT_CIVIL = ":idEtatCivilParam";
...
export const PATH_APERCU_REQ_ETABLISSEMENT_PRISE_EN_CHARGE =
  "apercurequetecreationetablissementpriseencharge";
...
export const URL_RECHERCHE_REQUETE_APERCU_REQUETE_CREATION_ETABLISSEMENT_PRISE_EN_CHARGE_ID = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_ETABLISSEMENT_PRISE_EN_CHARGE}/${ID}`;
export const URL_RECHERCHE_REQUETE_APERCU_REQUETE_CREATION_ETABLISSEMENT_SAISIE_PROJET_ID = `${URL_RECHERCHE_REQUETE}/${PATH_APERCU_REQ_ETABLISSEMENT_SAISIE_PROJET}/${ID}/${ID_ETAT_CIVIL}`;
...
export const URL_MES_REQUETES_CREATION_ETABLISSEMENT_APERCU_PRISE_EN_CHARGE_ID = `${URL_MES_REQUETES_CREATION}/${PATH_APERCU_REQ_ETABLISSEMENT_PRISE_EN_CHARGE}/${ID}`;
export const URL_MES_REQUETES_CREATION_ETABLISSEMENT_APERCU_SAISIE_PROJET_ID = `${URL_MES_REQUETES_CREATION}/${PATH_APERCU_REQ_ETABLISSEMENT_SAISIE_PROJET}/${ID}/${ID_ETAT_CIVIL}`;
...
export const URL_REQUETES_CREATION_SERVICE_ETABLISSEMENT_APERCU_PRISE_EN_CHARGE_ID = `${URL_REQUETES_CREATION_SERVICE}/${PATH_APERCU_REQ_ETABLISSEMENT_PRISE_EN_CHARGE}/${ID}`;
export const URL_REQUETES_CREATION_SERVICE_ETABLISSEMENT_APERCU_SAISIE_PROJET_ID = `${URL_REQUETES_CREATION_SERVICE}/${PATH_APERCU_REQ_ETABLISSEMENT_SAISIE_PROJET}/${ID}/${ID_ETAT_CIVIL}`;
...
export const URL_REQUETES_CREATION_SERVICE_TRANSCRIPTION_APERCU_REQUETE_SAISIE_PROJET_ID = `${URL_LES_REQUETE_CREATION_SERVICE}/${PATH_APERCU_REQ_TRANSCRIPTION_EN_SAISIE_PROJET}/${ID}`;
