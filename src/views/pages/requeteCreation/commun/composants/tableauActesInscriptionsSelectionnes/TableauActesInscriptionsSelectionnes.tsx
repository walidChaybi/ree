...
export const TableauActesInscriptionsSelectionnes: React.FC<
  ITableauActesInscriptionsSelectionnesProps
> = props => {
  const colonneIconeRetirerActeInscriptionParams: IColonneFontAwesomeIcone<
  ...
  return (
    <div className="ActesInscriptionsSelectionnesProjet">
      <div className="sousTitre">
        <span>
          {getLibelle("Actes et inscriptions sélectionnés pour le projet")}
        </span>
      </div>
      <TableauRece
