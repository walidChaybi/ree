...
export const createReponseSansDelivranceCSPourCompositionApiDemandeIncomplete = async (
...
export const createReponseSansDelivranceCSPourCompositionApiFrancais = async (
  ...
  let reponseSansDelivranceCS = {} as IReponseSansDelivranceCSFrancaisComposition;
  if (requete && requete.requerant) {
    reponseSansDelivranceCS = ReponseSansDelivranceCSFrancaisComposition.creerReponseSansDelivranceCS(
      requete
    );
  } else {
    messageManager.showErrorAndClose(ERREUR_PAS_DE_REQUERENT);
...
export const createReponseSansDelivranceCSPourCompositionApiMariage = async (
  ...
  let reponseSansDelivranceCS = {} as IReponseSansDelivranceCSMariageComposition;
  if (requete && requete.requerant && acte) {
    const infoActe = await getInformationsFicheActe(acte.idActe);
    reponseSansDelivranceCS = ReponseSansDelivranceCSMariageComposition.creerReponseSansDelivranceCS(
      requete,
