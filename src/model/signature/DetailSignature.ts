...
export type DetailSignature = DetailSignatureCommun & (DetailToCallAppSousType | DetailToWebextSousType);
export type DetailSignatureToCallApp = DetailSignatureCommun & DetailToCallAppSousType;
