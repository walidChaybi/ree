...
const LIBELLE_FONCTION_AGENT_3 = "code3.libelle.fonction.agent";
...
const SERVICE_DELIVREUR_NOM = "service.delivreur.nom";
...
export const SERVICE_DELIVREUR_SERVICE_TELEPHONE = "service.delivreur.service.telephone";
export const SERVICE_DELIVREUR_SERVICE_VILLE = "service.delivreur.service.ville";
export const BLOC_MARQUES_MINISTERE = "sceau.ministere.affaires.etrangeres";
export const SCEAU_MINISTERE = "sceau.signature";

const CLES_COMPOSITION = [
