...
export class ComplementObjetRequete extends EnumWithComplete {
  ...
  public static readonly TRANSCRIPTION_LUX_MON_POL_SUI_LIE =
    new ComplementObjetRequete(
  ...
  public static readonly TRANSCRIPTION_CONSULAT_ETRANGER =
    new ComplementObjetRequete(
  ...
  public static readonly QUESTION_AUTRE_INFORMATION =
    new ComplementObjetRequete(
