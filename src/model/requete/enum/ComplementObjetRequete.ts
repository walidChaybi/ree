...
export class ComplementObjetRequete extends EnumWithComplete {
  ...
  public static readonly MODIFICATION_RECTIFICATION_MAJ_ACTE =
    new ComplementObjetRequete(
      "MODIFICATION_RECTIFICATION_MAJ_ACTE",
      "Je souhaite rectifier, modifier et/ou mettre à jour un acte"
    );
  public static readonly DEMANDE_TRANSCRIPTION_MAGHREB =
    new ComplementObjetRequete(
  ...
  public static readonly TRANSCRIPTION_MAGHREB_ENVOYE_SANS_NOUVELLES =
    new ComplementObjetRequete(
  ...
  public static readonly TRANSCRIPTION_EUROPE_ENVOYE_SANS_NOUVELLES =
    new ComplementObjetRequete(
  ...
  public static readonly DEMANDE_TRANSCRIPTION_LUX_MON_POL_SUI_LIE =
    new ComplementObjetRequete(
  ...
  public static readonly DEMANDE_TRANSCRIPTION_AUTRE_PAYS =
    new ComplementObjetRequete(
  ...
  public static readonly DEMANDE_ACQUISITION_NATIONALITE =
    new ComplementObjetRequete(
      "DEMANDE_ACQUISITION_NATIONALITE",
      "J'ai demandé à acquérir la nationalité française"
    );
  public static readonly SUITE_ACQUISITION_NATIONALITE_DEMANDE_ACTE_EC_FR =
    new ComplementObjetRequete(
      "SUITE_ACQUISITION_NATIONALITE_DEMANDE_ACTE_EC_FR",
      "Je viens de devenir Français, je souhaite obtenir mon acte d'état civil"
    );
  public static readonly SUITE_ACQUISITION_NATIONALITE_DEMANDE_ACTE_EC_ETR =
    new ComplementObjetRequete(
  ...
  public static readonly BESOIN_JUSTIFICATIF_NATIONALITE =
    new ComplementObjetRequete(
  ...
  public static readonly MAJ_DUPLICATA_LIVRET_FAMILLE =
    new ComplementObjetRequete(
  ...
  public static readonly DELAIS_TRAITEMENT_DEMANDES =
    new ComplementObjetRequete(
  ...
  public static readonly QUESTION_DEMANDE_APOSTILLE =
    new ComplementObjetRequete(
      "QUESTION_DEMANDE_APOSTILLE",
      "Ma question concerne une demande d'apostille"
    );
  public static readonly QUESTION_DEMANDE_LEGALISATION_ACTE =
    new ComplementObjetRequete(
  ...
  public static readonly QUESTION_CASIER_JUDICIAIRE =
    new ComplementObjetRequete(
      "QUESTION_CASIER_JUDICIAIRE",
      "Ma question concerne un casier judiciaire"
    );
  public static readonly QUESTION_DEMANDE_CERTIFICAT_CAPACITE_MARIAGE =
    new ComplementObjetRequete(
  ...
  public static readonly CODE_VERIFICATION_NON_VISIBLE =
    new ComplementObjetRequete(
  ...
  public static estReponseLibreAgent(valeur: ComplementObjetRequete): boolean {
    return valeur === this.REPONSE_LIBRE_AGENT;
  }
}
